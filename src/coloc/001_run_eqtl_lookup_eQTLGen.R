...
#==================================================================
# File:        001_run_eqtl_lookup_eQTLGen.R
# Project:     SevereAsthma
# Author:      NNP - edited from AW
# Date:        2 November 2023
# Rationale:   Create eQTLGen and credset data for colocalisation
#==================================================================
...
eqtl = fread(paste0(tmp_path, "whole_blood_cis_eqtls_withAF.txt.gz"),
             showProgress=FALSE) %>%
