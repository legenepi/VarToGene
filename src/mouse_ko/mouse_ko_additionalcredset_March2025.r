...
sentinels <- fread("/home/n/nnp5/PhD/PhD_project/Var_to_Gene/input/Additional_credset_snps_March2025/Locus_PIPSentinel_chr_pos.txt") %>% rename(sentinel = PIP_Sentinel)
sentinels$chr <- as.numeric(sentinels$chr)
sentinels$pos <- as.numeric(sentinels$pos)
...
#release 2024-12-18 for additional credset variants March 2025::
#wget -P /scratch/gen1/nnp5/Var_to_Gen_tmp/mouse_ko/ https://ftp.ebi.ac.uk/pub/databases/impc/all-data-releases/latest/results/genotype-phenotype-assertions-ALL.csv.gz
#release 2023-11-22: release 2024-05-15 for chromosome 3:
#release 2024-07-26 for additional variants credset March 2025:
#wget -P /scratch/gen1/nnp5/Var_to_Gen_tmp/mouse_ko/ http://ftp.ebi.ac.uk/pub/databases/genenames/hcop/human_mouse_hcop_fifteen_column.txt.gz

orthologs <- read_tsv("/scratch/gen1/nnp5/Var_to_Gen_tmp/mouse_ko/human_mouse_hcop_fifteen_column.txt.gz")
all_geno_pheno <- read_csv("/scratch/gen1/nnp5/Var_to_Gen_tmp/mouse_ko/genotype-phenotype-assertions-ALL.csv.gz")
...
fwrite(ko_mouse_mp,"/home/n/nnp5/PhD/PhD_project/Var_to_Gene/input/Additional_credset_snps_March2025/MP_TERM_approx_asthma_respimmmuscle_additionalcredsetMarch2025.txt",quote=F, sep="\t")
...
out_base <- paste0("/scratch/gen1/nnp5/Var_to_Gen_tmp/mouse_ko/results_additionalcredsetMarch2025_", DISTANCE/1000, "kb")
...
inner_join(results_mko %>%
  ...
  arrange(p_value) %>%
  slice(1) %>%
  write_csv("mouse_ko_additionalcredsetMarch2025.csv")

#save genes only:
fwrite(as.data.frame(results_by_gene$Symbol), "/home/n/nnp5/PhD/PhD_project/Var_to_Gene/input/Additional_credset_snps_March2025/mouse_ko_genes_raw_additionalcredset_March2025.txt", na = "",col.names=F,quote=F)
