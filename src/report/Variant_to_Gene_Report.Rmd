...
```
Using the XXX I analysed if any human ortholog gene has been studied in mouse model in the context of respiratory, immune or muscle phenotypes
(top MP terms: respiratory system phenotype", "immune system phenotype", "muscle phenotype"). I selected relevant genes within 500Kb from the top causal variant for
