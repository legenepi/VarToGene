...
For my asthma project, I run the following cis-QTL types with the listed dataset:
 ...
 3. pQTL: pQTL UKBiobank, SCALLOP pQTL, INTERVAL pQTL; deCODE plasma
<br>
...
INTERVAL is
<br>
In GTExv8, I run co-localisation for the following tissues: 'Artery_Aorta', 'Artery_Coronary', 'Artery_Tibial', 'Colon_Sigmoid', 'Colon_Transverse', 'Esophagus_Gastroesophageal_Junction', 'Esophagus_Muscularis',  'Lung', 'Small_Intestine_Terminal_Ileum', 'Stomach'.
<br>
