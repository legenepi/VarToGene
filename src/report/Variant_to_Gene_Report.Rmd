...
I identified a total of 98 genes. For each analysis:
 ...
 - Functional annotation identified 39 genes (FANTOM 14 genes, Integrative scores 36 genes, ClinVar 6 genes);

 - eQTL: GTExV8 8 genes, eQTLgen blood 5 genes, UBC Lung eQTL 3 genes;

 - pQTL: UK Biobank 4 genes, SCALLOP 1 gene (no gene for deCODE);
...
No genes were found from the look-up analyses in the exome single or gene-based rare variant analyses. Full summary results available here:
```{r echo=FALSE}
xfun::embed_file('/home/n/nnp5/PhD/PhD_project/Var_to_Gene/src/report/var2gene_full.xlsx')
```

Out of the 98 genes, 24 genes were supported by at least 2 criteria (Figure 2):
 ...
 - 6 genes by four criteria: D2HGDH,IL4R,NSMCE1,RORA,RPS26,SMAD3
