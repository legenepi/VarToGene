...
## Look-up with protein quantitative trait loci (QTL) analysis
Code
<br>
...
```
I decided to perform a look-up of the 615 credible set varaints in three pQTL sources: deCODE, SCALLOP, and UKBiobank pQTL data.
<br>
I applied filters for significant association as 1.8E-9 for deCODE, 5e-8 for SCALLOP, and 0.05/1463 for UKBiobank pQTL data.
<br>
...
'asthma,eosin,immunodef,cili,autoimm,leukopenia,neutropenia,macroph'.
...
```
I performed single and gene-based collapsing ExWAS in the severe asthma case/control cohorts.
<br>
Single ExWAS was performed in 7,413 cases and 36,955 controls; I applied the same covariate of the discovery GWAS
(age_at_recruitment,age2,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10,genetic_sex). I used REGENIE v3.1.1
and the analysis was performed using the Research Analysis Platform. More detailed on the available code.
