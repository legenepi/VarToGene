...
Codes below are ordered as in their order of appearance in 'Var_to_Gene_pipeline.sh' scrip.

src/coloc/preprocess_cs.R
```{r, code = readLines('/home/n/nnp5/PhD/PhD_project/Var_to_Gene/src/coloc/preprocess_cs.R'), eval=FALSE, hide=TRUE}
```
...
<br>
For my asthma project, I run eQTL using GTExV8, eQTLGen blood, and UBC lung eQTL; sQTL using GTExV8; pQTL using deCODE plasma
